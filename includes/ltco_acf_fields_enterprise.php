...
if ( function_exists( 'acf_add_local_field_group' ) ) :
  acf_add_local_field_group(array(
    ...
    'fields' => array(
      ...
      array(
        'key' => 'ltco_enterprise__badge',
        'label' => 'Distintivo',
        'name' => 'ltco_enterprise__badge',
        'type' => 'group',
        'instructions' => '',
        'required' => 0,
        'conditional_logic' => 0,
        ...
        'sub_fields' => array(
          array(
            'key' => 'ltco_enterprise__badge__text',
            'label' => 'Descrição do Distintivo',
            'name' => 'ltco_enterprise__badge__text',
            'type' => 'text',
            'instructions' => '',
            'required' => 0,
            'conditional_logic' => 0,
          ...
          array(
            'key' => 'ltco_enterprise__badge__color',
            'label' => 'Cor do Distintivo',
            'name' => 'ltco_enterprise__badge__color',
            'type' => 'select',
            'instructions' => '',
            'required' => 0,
            'conditional_logic' => 0,
      ...
      array(
        'key' => 'ltco_enterprise__crm',
        'label' => 'CRM',
        'name' => 'ltco_enterprise__crm',
        'type' => 'group',
        'instructions' => '',
        'required' => 0,
        'conditional_logic' => 0,
        ...
        'sub_fields' => array(
          array(
            'key' => 'ltco_enterprise__crm__campaignkey',
            'label' => 'Chave da campanha',
            'name' => 'ltco_enterprise__crm__campaignkey',
            'type' => 'text',
            'instructions' => '',
            'required' => 0,
            'conditional_logic' => 0,
            ...
            'default_value' => '',
            'placeholder' => 'CampanhaKey',
            'prepend' => '',
            'append' => '',
            'maxlength' => '',
          ),
          array(
            'key' => 'ltco_enterprise__crm__productkey',
            'label' => 'Chave da produto',
            'name' => 'ltco_enterprise__crm__productkey',
            'type' => 'text',
            'instructions' => '',
            'required' => 0,
            'conditional_logic' => 0,
