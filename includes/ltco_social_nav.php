<?php
function ltco_social_nav($classWrapper = false) {
  ...
  $content_social_nav = "<nav class='ltco_social $classWrapper'>";
  ...
  foreach ( $sociais as $social ) {
    ...
    if ( !empty( $social['url'] ) ) {
      ...
      $ltco_src_icon_social = ltco_path('svgs')."/icon-$ltco_social_icon_name.svg";
